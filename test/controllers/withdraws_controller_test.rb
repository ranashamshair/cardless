...
class WithdrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdraw" do
    assert_difference('Withdraw.count') do
      post withdraws_url, params: { withdraw: { amount: @withdraw.amount, is_payed: @withdraw.is_payed, name: @withdraw.name, user_id: @withdraw.user_id } }
    end
  ...
  test "should update withdraw" do
    patch withdraw_url(@withdraw), params: { withdraw: { amount: @withdraw.amount, is_payed: @withdraw.is_payed, name: @withdraw.name, user_id: @withdraw.user_id } }
